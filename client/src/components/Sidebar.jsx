            ...
            <div className="pb-5">
                <div className="flex justify-between item-center">
                    ...
                    <div className='relative py-2 group'>
                        <Menu  className='mas-h-5 cursor-pointer' />
            ...
            <div className='flex flex-col'>
               {
                filteruser.map((user,index)=>(
                    ...
                    ${selectedUser?._id===user._id && 'bg-[#282142]/50'}`}>
                        ...
                        {unseenMessages[users._id]>0 && <p className='absolute top-4 right-4 text-xs h-5 w-5 flex justify-center
                          items-center rounded-full bg-violet-500/50'>{unseenMessages[users._id]}</p>}
                    </div>
                ))
               }
            </div>
